...
const BRANCH_LENS: Record<string, BranchLens> = {
  ...
  happened: {
    mechanism: "what the anger from this one event is actually pointing at",
    clarity: {
      1: "you're this angry and your answers were honest that you can't yet name which part of it did this. That's the first real question here, not a failure.",
      2: "your answers hold two true things at once — you're hurt and you're furious, or you want it undone and you know it can't be. The fury keeps running because you're making them compete.",
      3: "this isn't only tonight. Your answers point to the same line getting crossed before, so the anger is carrying more than one event's worth of charge.",
      4: "the line here was never stated out loud, or never held. Your answers point at structure rather than at feeling: nothing is marking where the limit is.",
      5: "your answers separate what they did from what you've concluded about it unevenly, and the conclusion is doing most of the burning.",
      6: "the heat is sitting on what this says about how they see you, or about standing there and saying nothing. That read is what keeps it at full volume.",
      7: "there's no move available yet that doesn't cost you more than it costs them, and your answers show the charge still needing somewhere to go.",
      8: "there's a piece of this you're assuming rather than knowing, or something you haven't said to their face. The event is being rebuilt each pass.",
    },
    next: {
      1: "Which single part of what happened has the most heat on it?",
      2: "What are the two things that are both true right now, said plainly?",
      3: "When did this exact line get crossed before, and what did you do then?",
      4: "What is the line, stated in one sentence they could not misread?",
      5: "What can you state as fact about what they did, and what is your read on it?",
      6: "What does this actually say about them, rather than about you?",
      7: "Where does the charge go tonight that costs you nothing?",
      8: "What don't you know yet, and who would you have to ask?",
    },
  },
