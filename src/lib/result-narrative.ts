...
const BRANCH_LENS: Record<string, BranchLens> = {
  ...
  bet: {
    mechanism: "what the urge to gamble is actually doing for you right now",
    clarity: {
      1: "your answers show the urge is real and unnamed. You're at the first honest look at it, not at an explanation of it.",
      2: "your answers hold both sides at once: the pull is genuine and the cost is real, and you didn't villainize yourself to resolve that.",
      3: "the urge is part of a recurring cycle — a time, a mood or a sequence your answers keep pointing back to. You're beginning to see the shape of that cycle.",
      4: "your answers point to unbounded access and unstructured time. The bet fills a gap that has no edges around it.",
      5: "what you know about how these sessions actually end and what you expect from this one are running together. The expectation is doing the pulling.",
      6: "your answers keep circling back to a case against yourself about money or control, and the prosecution is heavier than the urge.",
      7: "the bet is aimed at a state, not an outcome — your answers point to stimulation or escape from a flat, still feeling.",
      8: "your answers point outward: something unresolved with another person, or a reading of what they think, sitting under the urge.",
    },
    next: {
      1: "What is the most honest sentence about what you want the bet to do?",
      2: "What does gambling genuinely give you, and what does the same session take?",
      3: "What tends to happen immediately before you start wanting to gamble?",
      4: "What limit — money, time or access — would you set before the next urge rather than during it?",
      5: "What actually happens by the end of these sessions, as opposed to what you picture at the start?",
      6: "Can you name your part in this without turning it into a verdict on who you are?",
      7: "What feeling would you be sitting with for the next hour if you didn't place anything?",
      8: "Who else is affected by this, and what have you not said to them?",
    },
  },
  well: {
